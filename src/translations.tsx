export const Translations = [
  ...
  },
  {
    ...
    translation: {
      ...
      'wifi.login': '连接 WiFi',
      'wifi.name': '网络名称',
      'wifi.name.hiddenSSID': '隐藏的 SSID',
      'cards.additional': '要打印的额外卡片',
  ...
  },
  {
    ...
    translation: {
      ...
      'wifi.name': '網絡名稱',
      'wifi.name.hiddenSSID': '隐藏的 SSID',
      'cards.additional': '要打印嘅額外卡片',
      'cards.tip.hide': '收埋提示(圖例)',
  ...
  },
  {
    ...
    translation: {
      ...
      'cards.additional': '要打印嘅额外卡片',
      'cards.tip.hide': '收埋提示(图例)',
  ...
  },
  {
    ...
    translation: {
      ...
      'wifi.login': '連接 WiFi',
      'wifi.name': '網路名稱',
      'wifi.name.hiddenSSID': '隱藏的 SSID',
      'cards.additional': '要列印的額外卡片',
